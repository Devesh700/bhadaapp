...
import {
  PropertyFormData,
  propertyFormSchema,
} from "./step-forms/propertySchema"; // Ensure this is the new Zod schema (title, location.*, specifications.*, images, etc.)
  ...
  const handleFinalSubmission = async () => {
    ...
    if (!data.images?.length && imageFiles.length === 0) {
      toast({
        title: "Validation Error",
        description:
          "Please add at least one property image before submitting.",
        variant: "destructive",
      });
      setIsSubmitting(false);
      return;
          ...
          <DialogContent className="bg-card border-border text-foreground">
            ...
            <div className="text-center py-6">
              ...
              <p className="text-muted-foreground">
                Your property listing is being reviewed by our team. You'll be

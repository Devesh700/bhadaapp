...
const AmenitiesStep = ({ form, onFinalSubmit, isSubmitting = false }: AmenitiesStepProps) => {
  ...
  // Initialize selected amenities from form values
  useEffect(() => {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-300 rounded-lg p-4 mb-6">
        <p className="text-blue-800 text-sm font-medium">
          <strong>Final Step:</strong> Select the amenities available at your property. You can skip this step if none apply, then click "Submit Property" to complete your listing.
        </p>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {AMENITIES_LIST.map((amenity) => (
                  ...
                  >
                    ...
                    <label
                      htmlFor={amenity}
                      className="text-gray-900 text-sm font-medium cursor-pointer flex-1"
                    >
                      {amenity}
                    </label>
                  </div>
